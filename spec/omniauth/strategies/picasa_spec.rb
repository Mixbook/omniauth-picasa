require 'spec_helper'
require 'omniauth-picasa'

describe OmniAuth::Strategies::Picasa do
  ...
  subject do
    ...
    OmniAuth::Strategies::Picasa.new(app, *args).tap do |strategy|
  ...
  describe '#callback_path' do
    it 'has the correct callback path' do
      subject.callback_path.should eq('/auth/picasa/callback')
    end
  end
